<x-admin-layout>
    ...
    <form method="GET" class="bg-gray-800 border border-white/5 rounded-xl p-4 mb-6 flex flex-wrap gap-3 items-end">
        ...
        <button type="submit" class="px-5 py-2 bg-primary-600 hover:bg-primary-700 text-white text-sm rounded-lg transition">
            Filter
        </button>
                        ...
                        <td class="px-5 py-4">
                            <div class="w-32">
                                ...
                                <div class="h-1.5 bg-gray-700 rounded-full overflow-hidden">
                                    <div class="h-1.5 bg-primary-600 rounded-full" style="width: {{ $percent }}%"></div>
                                </div>
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <a href="{{ route('admin.campaigns.edit', $campaign) }}"
                                    class="p-1.5 rounded-lg bg-primary-600/10 hover:bg-primary-600/20 text-primary-400 hover:text-primary-300 transition" title="Edit">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
