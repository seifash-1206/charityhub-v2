    ...
    <form method="GET" class="bg-gray-800 border border-white/5 rounded-xl p-4 mb-6 flex flex-wrap gap-3 items-end">
        <div class="flex-1 min-w-44">
            ...
            <input type="text" name="search" value="{{ request('search') }}"
                ...
                class="w-full bg-gray-900 border border-white/10 text-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary-500">
        </div>
        <div>
                        ...
                        <td class="px-5 py-3.5">
                            <div class="flex items-center justify-center gap-1.5">
                                ...
                                <a href="{{ route('admin.volunteers.edit', $volunteer) }}"
                                    class="p-1.5 rounded-lg bg-primary-600/10 hover:bg-primary-600/20 text-primary-400 hover:text-primary-300 transition">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
