<x-admin-layout>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <!-- Total Raised -->
        <div class="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-2xl p-5 shadow-lg shadow-indigo-900/30">
            <div class="flex items-center justify-between mb-3">
                <p class="text-indigo-200 text-xs font-semibold uppercase tracking-wider">Total Raised</p>
                    ...
                    @forelse($topCampaigns as $campaign)
                        ...
                        <div class="px-5 py-3">
                            <div class="flex items-center justify-between mb-1.5">
                                ...
                                <p class="text-xs text-indigo-400 font-semibold flex-shrink-0">
