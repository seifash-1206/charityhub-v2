<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <!-- HERO HEADER -->
        <div class="mb-8">
            <p class="text-secondary-400 dark:text-secondary-500 text-sm font-medium">Welcome back,</p>
            <h1 class="text-3xl font-bold text-primary-900 dark:text-white tracking-tight">{{ auth()->user()->name }} 👋</h1>
            @if(auth()->user()->role === 'admin')
                <div class="mt-2 inline-flex items-center gap-2 text-xs px-3 py-1.5 rounded-full bg-primary-100 dark:bg-primary-900/40 text-primary-900 dark:text-primary-400 font-semibold">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-10">
            ...
            <!-- Total Raised -->
            <div class="relative bg-gradient-to-br from-primary-900 to-primary-800 dark:from-primary-800 dark:to-primary-700 rounded-2xl p-6 shadow-lg shadow-primary-900/20 dark:shadow-primary-950/40 overflow-hidden">
            ...
            <!-- Total Campaigns -->
            <div class="bg-white/60 dark:bg-secondary-800/40 backdrop-blur-xl border border-white/40 dark:border-secondary-700/30 rounded-2xl p-6 shadow-lg dark:shadow-secondary-900/20">
        ...
        @if(auth()->user()->role === 'admin')
            <div class="mb-8 p-5 bg-primary-50/70 dark:bg-primary-900/20 backdrop-blur border border-primary-100 dark:border-primary-900/40 rounded-2xl shadow-sm">
                <p class="text-xs font-semibold text-primary-900 dark:text-primary-400 uppercase tracking-wider mb-3">Admin Quick Access</p>
        ...
        <div class="grid lg:grid-cols-3 gap-7">
            ...
            <!-- Recent Campaigns -->
            <div class="lg:col-span-2 bg-white/60 dark:bg-secondary-800/40 backdrop-blur-xl border border-white/40 dark:border-secondary-700/30 rounded-2xl shadow-lg dark:shadow-secondary-900/20 overflow-hidden">
                <div class="px-6 py-4 border-b border-secondary-200 dark:border-secondary-700 flex items-center justify-between">
                    <h2 class="font-bold text-primary-900 dark:text-white">Recent Campaigns</h2>
                    ...
                    @forelse($recentCampaigns as $campaign)
                        ...
                        <a href="{{ route('campaigns.show', $campaign) }}"
                           class="block px-6 py-4 hover:bg-primary-50/40 dark:hover:bg-primary-900/20 transition group">
                            ...
                            <div class="h-1.5 bg-secondary-200 dark:bg-secondary-700 rounded-full overflow-hidden">
                                <div class="h-1.5 bg-gradient-to-r from-primary-600 to-primary-800 dark:from-primary-700 dark:to-primary-600 rounded-full transition-all"
                                     style="width: {{ min($progress, 100) }}%"></div>
                            </div>
                        </a>
                    @empty
                        <div class="px-6 py-10 text-center text-secondary-400 dark:text-secondary-500 text-sm">No campaigns yet</div>
                    @endforelse
                </div>
            </div>
            ...
            <div class="space-y-5">
                ...
                <!-- Recent Donations -->
                <div class="bg-white/60 dark:bg-secondary-800/40 backdrop-blur-xl border border-white/40 dark:border-secondary-700/30 rounded-2xl shadow-lg dark:shadow-secondary-900/20 overflow-hidden">
                    <div class="px-5 py-4 border-b border-secondary-200 dark:border-secondary-700 flex items-center justify-between">
                        <h2 class="font-bold text-primary-900 dark:text-white text-sm">Recent Donations</h2>
                    ...
                    <div class="divide-y divide-secondary-100 dark:divide-secondary-700">
                        @forelse($donations->take(5) as $donation)
                            <div class="px-5 py-3 flex items-center justify-between">
                                ...
                                <div class="text-right">
                                    ...
                                    <span class="text-xs
                                        @if($donation->status === 'paid') text-emerald-600 dark:text-emerald-400
                                        @elseif($donation->status === 'pending') text-amber-600 dark:text-amber-400
                        ...
                        @empty
                            <div class="px-5 py-8 text-center text-secondary-400 dark:text-secondary-500 text-sm">No donations yet</div>
                        @endforelse
                    </div>
                </div>

                <!-- Quick Actions -->
                <div class="bg-white/60 dark:bg-secondary-800/40 backdrop-blur-xl border border-white/40 dark:border-secondary-700/30 rounded-2xl p-5 shadow-lg dark:shadow-secondary-900/20">
                    <h2 class="font-bold text-primary-900 dark:text-white text-sm mb-4">Quick Actions</h2>
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('donations.track') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-xl bg-secondary-100 dark:bg-secondary-800 hover:bg-secondary-200 dark:hover:bg-secondary-700 transition group">
                            <span class="text-lg">🔍</span>
                            <span class="text-sm font-medium text-secondary-700 dark:text-secondary-300">Track a Donation</span>
                        </a>
                        <a href="{{ route('volunteers.create') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-xl bg-secondary-100 dark:bg-secondary-800 hover:bg-secondary-200 dark:hover:bg-secondary-700 transition group">
                            <span class="text-lg">🙋</span>
                            <span class="text-sm font-medium text-secondary-700 dark:text-secondary-300">Volunteer</span>
                        </a>
                        <a href="{{ route('donations.my') }}"
                           class="flex items-center gap-3 px-4 py-3 rounded-xl bg-secondary-100 dark:bg-secondary-800 hover:bg-secondary-200 dark:hover:bg-secondary-700 transition group">
                            <span class="text-lg">💙</span>
                            <span class="text-sm font-medium text-secondary-700 dark:text-secondary-300">My Donations</span>
                        </a>
                    </div>
                </div>
