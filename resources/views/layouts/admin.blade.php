...
<head>
    ...
    <style>
        ...
        .sidebar-link svg { flex-shrink: 0; width: 1.125rem; height: 1.125rem; }
        ...
        .admin-badge-danger  { background: #fee2e2; color: #7f1d1d; }
    ...
    <aside class="fixed inset-y-0 left-0 w-64 bg-gray-900 border-r border-white/5 flex flex-col z-40 shadow-2xl">
        ...
        <div class="px-6 py-5 border-b border-white/5">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2.5">
                ...
                <div>
                    <span class="font-bold text-white text-sm tracking-tight">charity<span class="text-indigo-400">hub</span></span>
                    <p class="text-xs text-indigo-400 font-medium -mt-0.5">Admin Portal</p>
                </div>
            </a>
        </div>
        ...
        <header class="sticky top-0 z-30 bg-gray-900/80 backdrop-blur border-b border-white/5 px-8 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <span class="text-xs px-2.5 py-1 rounded-full bg-indigo-500/20 text-indigo-300 font-medium">
                        Administrator
                    </span>
